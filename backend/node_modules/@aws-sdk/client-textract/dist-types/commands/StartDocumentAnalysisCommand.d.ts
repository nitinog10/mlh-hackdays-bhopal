...
declare const StartDocumentAnalysisCommand_base: {
    new (input: StartDocumentAnalysisCommandInput): import("@smithy/core/client").CommandImpl<StartDocumentAnalysisCommandInput, StartDocumentAnalysisCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartDocumentAnalysisCommandInput): import("@smithy/core/client").CommandImpl<StartDocumentAnalysisCommandInput, StartDocumentAnalysisCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
