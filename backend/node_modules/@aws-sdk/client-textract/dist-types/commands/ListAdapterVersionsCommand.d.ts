...
declare const ListAdapterVersionsCommand_base: {
    new (input: ListAdapterVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListAdapterVersionsCommandInput, ListAdapterVersionsCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAdapterVersionsCommandInput]): import("@smithy/core/client").CommandImpl<ListAdapterVersionsCommandInput, ListAdapterVersionsCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
