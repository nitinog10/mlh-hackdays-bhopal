...
declare const UpdateAdapterCommand_base: {
    new (input: UpdateAdapterCommandInput): import("@smithy/core/client").CommandImpl<UpdateAdapterCommandInput, UpdateAdapterCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAdapterCommandInput): import("@smithy/core/client").CommandImpl<UpdateAdapterCommandInput, UpdateAdapterCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
