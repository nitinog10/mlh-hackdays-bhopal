...
declare const StartDocumentTextDetectionCommand_base: {
    new (input: StartDocumentTextDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartDocumentTextDetectionCommandInput, StartDocumentTextDetectionCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartDocumentTextDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartDocumentTextDetectionCommandInput, StartDocumentTextDetectionCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
