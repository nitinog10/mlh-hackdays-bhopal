...
declare const GetLendingAnalysisCommand_base: {
    new (input: GetLendingAnalysisCommandInput): import("@smithy/core/client").CommandImpl<GetLendingAnalysisCommandInput, GetLendingAnalysisCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLendingAnalysisCommandInput): import("@smithy/core/client").CommandImpl<GetLendingAnalysisCommandInput, GetLendingAnalysisCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
