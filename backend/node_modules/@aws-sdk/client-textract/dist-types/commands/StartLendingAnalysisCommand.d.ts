...
declare const StartLendingAnalysisCommand_base: {
    new (input: StartLendingAnalysisCommandInput): import("@smithy/core/client").CommandImpl<StartLendingAnalysisCommandInput, StartLendingAnalysisCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartLendingAnalysisCommandInput): import("@smithy/core/client").CommandImpl<StartLendingAnalysisCommandInput, StartLendingAnalysisCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
