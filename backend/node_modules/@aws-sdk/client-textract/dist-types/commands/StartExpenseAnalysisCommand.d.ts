...
declare const StartExpenseAnalysisCommand_base: {
    new (input: StartExpenseAnalysisCommandInput): import("@smithy/core/client").CommandImpl<StartExpenseAnalysisCommandInput, StartExpenseAnalysisCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartExpenseAnalysisCommandInput): import("@smithy/core/client").CommandImpl<StartExpenseAnalysisCommandInput, StartExpenseAnalysisCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
