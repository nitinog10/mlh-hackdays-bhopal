...
declare const ListAdaptersCommand_base: {
    new (input: ListAdaptersCommandInput): import("@smithy/core/client").CommandImpl<ListAdaptersCommandInput, ListAdaptersCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAdaptersCommandInput]): import("@smithy/core/client").CommandImpl<ListAdaptersCommandInput, ListAdaptersCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
