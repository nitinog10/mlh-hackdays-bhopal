...
declare const GetLendingAnalysisSummaryCommand_base: {
    new (input: GetLendingAnalysisSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetLendingAnalysisSummaryCommandInput, GetLendingAnalysisSummaryCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLendingAnalysisSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetLendingAnalysisSummaryCommandInput, GetLendingAnalysisSummaryCommandOutput, import("..").TextractClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
